...
namespace ScanApp.Tests.UnitTests.Domain.ValueObjects
{
    public class RecurrencePatternTests
    {
        ...
        [InlineData(Day.Friday | Day.Saturday)]
        [InlineData(Day.Friday | Day.Saturday | Day.Tuesday)]
        public void Monthly_occurrence_throws_arg_out_of_range_if_gt_one_day_is_given(Day day)
        {
        ...
        [InlineData((Day)0)]
        [InlineData((Day)1024)]
        public void Monthly_occurrence_throws_enum_exception_if_undefined_day_is_given(Day day)
        {
            Action act = () => RecurrencePattern.Monthly(1, Week.First, day);
        ...
        [InlineData(-5)]
        [InlineData(32)]
        public void Monthly_occurrence_throws_arg_exception_if_invalid_day_number_is_given(int day)
        {
            Action act = () => RecurrencePattern.Monthly(1, day);
        ...
        [InlineData(0)]
        [InlineData(-10)]
        public void Yearly_recurrence_throws_Arg_out_of_range_if_interval_lt_1(int interval)
        {
            Action act = () => RecurrencePattern.Yearly(interval, 11, 24);
        ...
        [InlineData(-5)]
        [InlineData(32)]
        public void Yearly_occurrence_throws_arg_exception_if_invalid_day_number_is_given(int day)
        {
            Action act = () => RecurrencePattern.Yearly(1, 11, day);
        ...
        [InlineData(-5)]
        [InlineData(13)]
        public void Yearly_occurrence_throws_arg_exception_if_invalid_month_number_is_given(int month)
        {
            Action act = () => RecurrencePattern.Yearly(1, month, 24);
        ...
        [InlineData(Day.Friday | Day.Saturday)]
        [InlineData(Day.Friday | Day.Saturday | Day.Tuesday)]
        public void Yearly_occurrence_throws_arg_out_of_range_exception_if_gt_one_day_is_given(Day day)
        {
            Action act = () => RecurrencePattern.Yearly(1, 11, Week.First, day);
        ...
        [InlineData((Week)(-1))]
        [InlineData((Week)100)]
        public void Yearly_recurrence_occurrence_throws_enum_exception_if_undefined_week_is_given(Week week)
        {
            Action act = () => RecurrencePattern.Yearly(1, 11, week, Day.Monday);
